export const mainMusic = new Audio(
...
export const readyForInput = new Audio(
  'https://cia-9d562a98.s3.us-west-1.amazonaws.com/GameAssets/SoundFX/Daffodil362Ready.wav'
);

export const buttonPress = new Audio(
  'https://cia-9d562a98.s3.us-west-1.amazonaws.com/GameAssets/SoundFX/Daffodil362KeyPress.wav'
);

export const successSound = new Audio(
  'https://cia-9d562a98.s3.us-west-1.amazonaws.com/GameAssets/SoundFX/Daffodil362SuccessNEW.wav'
);
